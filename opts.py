...
parser.add_argument('--dataset', type=str, default='moments')#choices=['something','jester','moments'])
parser.add_argument('--modality', type=str, default='RGB') #choices=['RGB', 'Flow'])
parser.add_argument('--train_list', type=str,default="")
parser.add_argument('--val_list', type=str, default="")
parser.add_argument('--root_path', type=str, default="/home/lili/Video/datasets/validation")
